# This is for NA-LOCCNet (S=1) in the figure (P_succ vs gamma for fixed p)
...
# For p=0.25 we optimize the rotation angles at Alice and Bob
...
p = torch.tensor(0.25, dtype=torch.complex128) #prob of noisy channels between Alice and Bob
...
plt.legend(["LOCCNet trained at p=0.25"], loc="lower left", fontsize=12)
