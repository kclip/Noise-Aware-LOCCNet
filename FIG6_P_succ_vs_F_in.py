# Python (Pytorch) code to implement NA-LOCCNet and plot Probability of success vs input fidelity for fixed bit flip probability.
...
for i in range(0, 11, 1):   # i runs from 0 to 10
    ...
    # This cost function is to find P_opt using optimum theta
    def cost1(theta):
...
# plt.ylabel("Probability of success", fontsize=11)
